...
<!--  <button style="margin-left: 15px;" onclick="printDiv()" class="btn btn-success">Print</button>
 <br>
 <br> -->
  ...
  <div onload="window.print()" class="modal_body_parameter_list container" id="print_data">
    ...
    <table class="table table-bordered">
      ...
      ?>
          ...
          <td>
            <?php 
              foreach($requests as $single_req_data){
                ...
                $entry_user_data = DB::select(DB::raw("select ui.name,ui.user_id,ui.contact, ui.emp_id  from [request_id] ri left join [users] ui on ri.br_maker = ui.id where req_id='$request_id'"));
                ...
                if ($entry_user_data[0]->contact) {
                  echo "<br>";
                  echo "Phone : ".$entry_user_data[0]->contact;
                }
        ...
        <tr>
          ...
          <td><?php 
            ...
            foreach ($requests as  $single_req_data) {
             ...
             echo  $req_maker_emp_id = $single_req_data['req_maker_emp_id'];
             echo "<br>";
            
            }
             if (empty($req_maker_emp_id)) {
              echo $entry_user_data[0]->emp_id;
            }
           ?></td>
        </tr>
        ...
        <tr>
          ...
          <td>
            <?php
           $get_data = DB::select(DB::raw("SELECT * FROM designation_log where log_reguest_id='$request_id' "))[0];

          echo $get_data->log_user_designation;
             ?>
          </td>
         ...
         if ($branch_code=='202') {
           ...
           echo $branch_data->name." ($division_name)"." ($branch_code) ";
         }else{
        ...
        <tr>
           ...
           foreach($requests as $single_branch_maker){
            ...
            if ($user_role_id=='9' || $user_role_id=='10' || $user_role_id=='8') {
            ...
            }elseif($user_role_id=='1' || $user_role_id=='5') {
              // code...
        ...
        <tr>
          ...
          <?php 
            ...
            foreach($requests as $single_branch_checker){
               ...
               $user_role_id = $single_branch_checker['user_role_checker'];
      ...
      <?php 
        ...
        <?php 
              ...
              ?>
                 ...
                 <tr>
                    <th>Domain Id (Request Maker)</th>

                    <td><?php 

                       foreach($requests as $single_system2){

                       echo $request_type_system_id = $single_system2['br_maker_domain_id'];
       ...
       <?php 
        ...
        foreach($requests as $single_user_pass){
                ...
                $br_maker =  $single_user_pass['br_maker'];

                 if ($request_type_name=="New ID Creation" &&  (Auth::user()->role==2 ||  Auth::user()->id==$br_maker)) {
          ?>
       ...
       <?php
          ...
          }elseif ($request_type_name=="New ID Creation" && ( Auth::user()->role !=2 ||  Auth::user()->id !=$br_maker)) {
       ...
       <?php 
        ...
        foreach($requests as $reset_pass){
                ...
                $br_maker =  $reset_pass['br_maker'];

                 if ($request_type_name=="Password Reset" &&  (Auth::user()->role==2 ||  Auth::user()->id==$br_maker)) {
          ?>
       ...
       <?php
          ...
          }elseif ($request_type_name=="Password Reset" && ( Auth::user()->role!=2 ||  Auth::user()->id!=$br_maker)) {
              ...
              <?php 
                if ($para_id=='158') {
                 ?>
                    ...
                    <p><?php echo urldecode($para_val); ?></p>
                    <hr>
                   <?php 
                }else{

                  if($para_name=='Remarks' || $para_name=='Remarks:'){
                      ?>
