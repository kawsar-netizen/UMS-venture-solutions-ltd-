                  ...
                  if(Auth::user()->role=='1' || Auth::user()->role=='5'){
                           ...
                           <div class="form-group row" style="">
                              <div class="col-lg-offset-2 col-lg-10">
                                 <div class="i-checks">
                                    ...
                                    <input name="rtgs2_radio"  class="showRtgsEnhanceMentDateTime" value="143" id="temporay_exp_date" type="radio" onclick="rtgsEnhancementDateTimeLabelSelect('143','chk',1,'6');">

                                    <label for="temporay_exp_date" class="temporay_exp_date">Temporary Expire Date and Time</label>                                
                                    <br>

                                    <input type="text" name="rtgs_tmp_exp_date" id="rtgs_tmp_exp_date" class="rtgs_tmp_exp_date" onclick="rtgsEnhancementDateTimeAdd('1814',document.getElementById('rtgs_tmp_exp_date').value,1,'6');">

                                    <input type="text" name="rtgs_tmp_exp_time" id="rtgs_tmp_exp_time" class="rtgs_tmp_exp_time" onclick="rtgsEnhancementDateTimeAdd('1815',document.getElementById('rtgs_tmp_exp_date').value,1,'6');">
                           ...
                           <div class="form-group row" style="">
                              <div class="col-lg-offset-2 col-lg-10">
                                 <div class="i-checks">
                                    ...
                                    <input name="rtgs2_radio" value="144" id="permanent" type="radio"><label for="permanent" onclick="rtgs_permanent();rtgsEnhancementParmanentAdd('144','chk',1,'6');">Permanent</label>
                     ...
                     <table class="table mcr">
                         ...
                         <tr>
                            ...
                            <td>
                               <label class="checkbox-inline">
                                 <input type="checkbox" value="151" name="151" onclick="setparameterId('151','chk',1,'6')">&nbsp; Fund Manager
                               </label>
                           ...
                           <div class="form-group row" style="">
                              <div class="col-lg-offset-2 col-lg-10">
                                 <div class="i-checks">
                                    ...
                                    <input name="rtgs2_radio" value="143" id="temporay_exp_date2" class="showRtgsEnhanceMentDateTime" type="radio" onclick="rtgsEnhancementDateTimeLabelSelect('143','chk',1,'6');">
   ...
   if(action==1)//add to list
   {
	  ...
	  // if seletected rtgs parmanent then remove 
		if(seletected_parameter_id == 144 || seletected_parameter_id == 1814 || seletected_parameter_id == 1815){
			parameter_list = removeRtgsDateTimePermanentFiledFromParameterList(prameter_list, seletected_parameter_id);
