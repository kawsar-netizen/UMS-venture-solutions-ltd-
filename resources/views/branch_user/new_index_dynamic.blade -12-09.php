                     ...
                     <div class="col-md-6">
                        <form>
                           ...
                           <div class="form-group row">
                              ...
                              <div class="col-sm-7">
                                 <input readonly name="" value="{{$user_form_data->emp_id}}" type="text" class="form-control">
                              </div>
                           </div>
                           <div class="form-group row">
                     ...
                     <div class="col-md-6">
                        <form>
                           <div class="form-group row">
                              ...
                              <div class="col-sm-7">
                                 <input readonly name="" value="{{$user_form_data->name}} ({{$user_form_data->emp_id}})" type="text" class="form-control">
                              </div>
                           </div>
                           <div class="form-group row">
...
<input type="text" name="systemList" id="systemList"  value="" >
<input type="text" name="requestTypeList" id="requestTypeList" value="" >
<input type="text" name="parameterList" id="parameterList" value="" >
...
<div class="container wrapper wrapper-content" style="max-height: 80%">
   ...
   <!--  end Assign person -->
      ...
      <div id="para_list" style="display: block;">
         ...
         <div class="wrapper wrapper-content animated fadeInRight request_type_class"  id="{{$sl->id}}_request_box" style="display: none;">
            ...
            <div class="p-2 mb-4 request_background_color_{{$sl->id}}" align="center" style="color: white">
                ...
                <b> {{$sl->system_name}} Request Type</b></div>
            ...
            <div class="ibox">
             ...
             <input id="requst_type_user_id{{$single_request->id}}" name="radio{{$sl->id}}" onclick="request_type_hide({{$single_request->system_id}}),setRequestTypeId('{{$single_request->id}}',1,'{{$single_request->system_id}}'),requestSectionHide('{{$single_request->id}}','{{$single_request->system_id}}', '{{$single_request->request_type_name}}'), requestSectionHide2('{{$single_request->id}}','{{$single_request->system_id}}', '{{$single_request->request_type_name}}')" required value="{{$single_request->request_type_name}}" type="radio" > 

                                    <label style="color: black;" for="requst_type_user_id{{$single_request->id}}" id="requst_type_user_id{{$single_request->id}}" >{{$single_request->request_type_name}}</label>
                            ...
                            <div class="form-group row">
                              <div class="col-lg-offset-2 col-lg-10">
                                 <div class="i-checks"> 
                                    ...
                                    name="radio{{$sl->id}}" onclick="req_type_func({{$single_request->id}}, {{$single_request->system_id}});requestSectionHide('{{$single_request->id}}','{{$single_request->system_id}}', '{{$single_request->request_type_name}}'),requestSectionHide2('{{$single_request->id}}','{{$single_request->system_id}}', '{{$single_request->request_type_name}}')" value="{{$single_request->request_type_name}}" type="radio" required> 
      ...
      <!-- request Type end -->
         ...
         <div class="wrapper wrapper-content animated fadeInRight {{$sl->id}}_hasan"  id="{{$sl->id}}_box" style="display: none;">
            
            <div class="p-2 mb-2 request_background_color_{{$sl->id}}" align="center" style="color: white;"><b> {{$sl->system_name}} Roles</b></div>
            ...
            <div class="ibox">
               <div class="ibox-content">
                  ...
                  if(Auth::user()->role=='1' || Auth::user()->role=='5'){
                     ...
                     if($rtgs_count === 1){
                         ...
                         <tr >
                            ...
                            <td >
                               <label class="checkbox-inline">
                                 <input type="checkbox" value="131" name="131" onclick="setparameterId('131','chk',1,'6')">&nbsp; Maker
                               </label>
                            ...
                            <td>
                                <label class="checkbox-inline">
                                 <input type="checkbox" value="133" name="133" onclick="setparameterId('133','chk',1,'6')">&nbsp; Checker
                               </label>
                            </td>
                            ...
                            <td>
                               <label class="checkbox-inline">
                                 ...
                                 <input type="checkbox" value="134" name="134"  onclick="setparameterId('134','chk',1,'6')">&nbsp; Report Viewer
                      ...
                      <table class="table display">
                         ...
                         <tr>
                           ...
                           <td></td>
                            <td><h4 class="text-center display">Checker Authorizer Limit</h4></td> 
                            <td></td>
                        </tr>
                         ...
                         <tr class="display">
                            ...
                            <td><input name="rtgs_radio" value="135" id="parameter_id_rtgs_template0" type="radio" onclick="setparameterId('135','chk',1,'6')">

                           <label for="parameter_id_rtgs_template0" >Head Office  </label></td>
                         ...
                         <tr class="display">
                            <td>
                              <input name="rtgs_radio" value="136" id="parameter_id_rtgs_template1" type="radio" onclick="setparameterId('136','chk',1,'6')">
                           ...
                           <tr class="display">
                               <td>
                                <input name="rtgs_radio" value="137" id="parameter_id_rtgs_template2" type="radio" onclick="setparameterId('137','chk',1,'6')">
                         ...
                         <tr class="display">
                              <td>
                                <input name="rtgs_radio" value="138" id="parameter_id_rtgs_template3" type="radio"  onclick="setparameterId('138','chk',1,'6')">
                         ...
                         <tr class="display">
                              <td>
                                <input name="rtgs_radio" value="139" id="parameter_id_rtgs_template4" type="radio"  onclick="setparameterId('139','chk',1,'6')">
                         ...
                         <tr class="display">
                              <td>
                                 <input name="rtgs_radio" value="140" id="parameter_id_rtgs_template5" type="radio" onclick="setparameterId('140','chk',1,'6')">
                         ...
                         <tr class="display">
                              <td>
                                 <input name="rtgs_radio" value="141" id="parameter_id_rtgs_template6" type="radio" onclick="setparameterId('141','chk',1,'6')">
                         ...
                         <tr class="display">
                              <td>
                                 <input name="rtgs_radio" value="142" id="parameter_id_rtgs_template7" type="radio" onclick="setparameterId('142','chk',1,'6')">
                           ...
                           <div class="form-group row" style="">
                              <div class="col-lg-offset-2 col-lg-10">
                                 <div class="i-checks">
                                    ...
                                    <input name="rtgs2_radio" value="143" id="temporay_exp_date" type="radio" onclick="rtgs_tmp_exp_date();setparameterId('143','chk',1,'6');">

                                    <label for="temporay_exp_date" class="temporay_exp_date"
                                     onclick="rtgs_tmp_exp_date();">Temporary Expire Date and Time</label>                                
                                    <br>

                                    <input type="date" name="rtgs_tmp_exp_date" id="rtgs_tmp_exp_date" class="rtgs_tmp_exp_date" onclick="setparameterId('1814',document.getElementById('rtgs_tmp_exp_date').value,1,'6');">


                                    <input type="time" name="rtgs_tmp_exp_time" id="rtgs_tmp_exp_time" class="rtgs_tmp_exp_time" onclick="setparameterId('1815',document.getElementById('rtgs_tmp_exp_date').value,1,'6');">
                           ...
                           <div class="form-group row" style="">
                              <div class="col-lg-offset-2 col-lg-10">
                                 <div class="i-checks">
                                    ...
                                    <input name="rtgs2_radio" value="144" id="permanent" type="radio"><label for="permanent" onclick="rtgs_permanent();setparameterId('144','chk',1,'6');">Permanent</label>
                     ...
                     <div class="col-lg-6 display">
                        <div class="form-group row" style="">
                           <div class="col-lg-6">
                              ...
                              <input type="text" name="158" value="" onclick="setparameterId('158',this.value,1,'6');">
                           </div>
                        </div>
                     </div>
                      ...
                      <div class="col-lg-6 display">
                        <div class="form-group row" style="">
                           <div class="col-lg-6">
                              ...
                              <input class="template_number_readonly" type="text" name="145" value="{{$user_form_data->designation}}" onclick="setparameterId('145',this.value,1,'6');" readonly>
                           </div>
                        </div>
                     </div>
                  ...
                  }if(Auth::user()->role=='2' || Auth::user()->role=='6' || Auth::user()->role=='9' || Auth::user()->role=='10' || Auth::user()->role=='8'){
                     ...
                     <table class="table mcr">
                         ...
                         <tr>
                            ...
                            <td>
                               <label class="checkbox-inline">
                                 <input type="checkbox" value="148" name="148" onclick="setparameterId('148','chk',1,'6')">&nbsp; Maker
                               </label>
                            ...
                            <td>
                                <label class="checkbox-inline">
                                 <input type="checkbox" value="149" name="149" onclick="setparameterId('149','chk',1,'6')">&nbsp; Checker
                               </label>
                            </td>

                            <td>
                               <label class="checkbox-inline">
                                 <input type="checkbox" value="150" name="150" onclick="setparameterId('150','chk',1,'6')">&nbsp; Report Viewer
                               </label>
                            ...
                            <td>
                               <label class="checkbox-inline">
                                 <input type="checkbox" value="1802" name="1802" onclick="setparameterId('1802','chk',1,'6')">&nbsp; Fund Transfer
                               </label>
                            ...
                            <td>
                               <label class="checkbox-inline">
                                 <input type="checkbox" value="1803" name="1803" onclick="setparameterId('1803','chk',1,'6')">&nbsp; Admin
                               </label>
                   ...
                   <tr>
                      <td>
                               <label class="checkbox-inline">
                                 <input type="checkbox" value="1804" name="1804" onclick="setparameterId('1804','chk',1,'6')">&nbsp; Banks Miscellaneous (HO)
                               </label>
                            ...
                            <td>
                               <label class="checkbox-inline">
                                 <input type="checkbox" value="1805" name="1805" onclick="setparameterId('1805','chk',1,'6')">&nbsp; Inter Bank Forex (HO)
                               </label>
                            ...
                            <td>
                               <label class="checkbox-inline">
                                 <input type="checkbox" value="1806" name="1806" onclick="setparameterId('1806','chk',1,'6')">&nbsp; Inter Bank Local (HO)
                               </label>
                            ...
                            <td>
                               <label class="checkbox-inline">
                                 <input type="checkbox" value="1807" name="1807" onclick="setparameterId('1807','chk',1,'6')">&nbsp; UM Maker (For IT)
                               </label>
                              ...
                              <td>
                                 <label class="checkbox-inline">
                                   <input type="checkbox" value="1808" name="1808" onclick="setparameterId('1808','chk',1,'6')">&nbsp; UM Checker (For IT)
                                 </label>
                      ...
                      <table class="table display">
                         ...
                         <tr  class="display">
                            ...
                            <td><input name="rtgs_radio" value="135" id="parameter_id_rtgs_template0" type="radio"><label for="parameter_id_rtgs_template0" onclick="setparameterId('135','chk',1,'6')">Head Office  </label></td>
                         ...
                         <tr  class="display">
                            <td><input name="rtgs_radio" value="136" id="parameter_id_rtgs_template1" type="radio"><label for="parameter_id_rtgs_template1" onclick="setparameterId('136','chk',1,'6')"> SO/Officer  </label> </td>
                           ...
                           <tr  class="display">
                               <td>
                                ...
                                <label for="parameter_id_rtgs_template2" onclick="setparameterId('137','chk',1,'6')"> PO </label>
                              </td>
                           ...
                           <div class="form-group row" style="">
                              <div class="col-lg-offset-2 col-lg-10">
                                 <div class="i-checks">
                                    ...
                                    <input name="rtgs2_radio" value="143" id="temporay_exp_date2" type="radio" onclick="rtgs_tmp_exp_date();setparameterId('143','chk',1,'6');">

                                    <label for="temporay_exp_date2" onclick="rtgs_tmp_exp_date();">Temporary Expire Date and Time </label>

                                     <br>
                                    
                                    <input type="date" name="rtgs_tmp_exp_date" id="rtgs_tmp_exp_date" class="rtgs_tmp_exp_date" onclick="setparameterId('1817',document.getElementById('rtgs_tmp_exp_date').value,1,'6');">
                                    
                                    <input type="time" name="rtgs_tmp_exp_time" id="rtgs_tmp_exp_time" class="rtgs_tmp_exp_time" onclick="setparameterId('1816',document.getElementById('rtgs_tmp_exp_date').value,1,'6');">
                     ...
                     <div class="col-lg-6 display">
                      ...
                      <div class="col-lg-6 display">
                        <div class="form-group row" style="">
                           <div class="col-lg-6">
                              <label>Previous Level of the checker Template Number</label>
                              <input type="text" class="template_number_readonly" name="145" value="{{$user_form_data->designation}}" onclick="setparameterId('145',this.value,1,'6');" readonly>
                           </div>
                        </div>
                     </div>
                  ...
                  <div class="row">
                     ...
                     <div class="col-lg-4">
                        <div class="form-group row" style="">
                           <div class="col-lg-offset-2 col-lg-10">
                              <div class="i-checks">
                                 <input name="{{$sys_para->para_id}}" value="{{$sys_para->para_id}}" id="parameter_id{{$sys_para->para_id}}" type="checkbox" onclick="setparameterId('{{$sys_para->para_id}}','chk',1,'{{$sys_para->system_id}}')">
                     ...
                     <div class="col-lg-4">
                        <div class="form-group row" style="">
                           <div class="col-lg-6">
                              ...
                              <input type="text" name="{{$sys_para->para_id}}" value="" onchange="setparameterId('{{$sys_para->para_id}}',this.value,1,'{{$sys_para->system_id}}')">
                           </div>
                        </div>
                     </div>
                     @endif
   ...
   if(action==1)//add to list
   {
     // alert(sysId+"----"+requestTypeId);
      ...
      }else
      {
         ...
         {
            sys=sysSet[i].split("-");
            if(sys[1]==requestTypeId && sys[0]==sysId)//already request type clicked so now it will be removed 
            {
...
function setparameterId(parameterId,parameterVal,action,sysId)
{
    ...
    //console.log(parameterId+'halim'+sysId);
   ...
   if(action==1)//add to list
   {
      ...
      var array=newString.split(",");
      var a=array.filter(onlyUnique);
      document.getElementById('parameterList').value=a.toString();
   }
   else
   {
      var sysSet=previous.split(",");
  ...
  //console.log('document.querySelectorAll("<?php print $checkList;?>")');
   ...
   const colors = ["#ffb700", "#a3b0c2","#ff6666", "#19b319","#b300b3", "#3385ff","#66cc66", "#206020","#ffb700", "#a3b0c2","#ffb700", "#a3b0c2"];
     ...
     // alert(test);return false;
      ...
      $.ajaxSetup({
        ...
        // return false; 
         ...
         // console.log(parameterList+'halim k');return false;
...
<script>
  ...
  function requestSectionHide(id, system_id, request_type_name){
    if(request_type_name=='Enhancement'){
   ...
   $(".display_permanent").css('display','');
    ...
    }else if(request_type_name !='Enhancement'){
