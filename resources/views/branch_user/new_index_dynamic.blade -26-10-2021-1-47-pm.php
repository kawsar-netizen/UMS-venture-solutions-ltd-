             ...
             <input id="requst_type_user_id{{$single_request->id}}" name="radio{{$sl->id}}" onclick="request_type_hide({{$single_request->system_id}}),setRequestTypeId('{{$single_request->id}}',1,'{{$single_request->system_id}}'),requestSectionHide('{{$single_request->id}}','{{$single_request->system_id}}', '{{$single_request->request_type_name}}'), requestSectionHide2('{{$single_request->id}}','{{$single_request->system_id}}', '{{$single_request->request_type_name}}')" required value="{{$single_request->request_type_name}}" type="radio" > 
                         ...
                         ?>
                           ...
                           <div class="form-group row" id="box{{$single_request->id}}" style="display: none;">
                              ...
                              <div class="col-lg-12">
                                 <label>User ID : </label>
                                 <input type="text" name="new_u_{{$single_request->id}}"  id="new_u_{{$single_request->id}}"  value="">
                              </div>
                  ...
                  if(Auth::user()->role=='1' || Auth::user()->role=='5'){
                         ...
                         <tr>
                            ...
                            <td>
                               <label class="checkbox-inline">
                                 ...
                                 onclick="setparameterId('2113','chk',1,'6')">&nbsp;Checker (Temp 1): SO/Officer
                         ...
                         <tr>
                            ...
                            <td >
                               <label class="checkbox-inline">
                                 <input type="checkbox" value="2114" name="2114"
                                  onclick="setparameterId('2114','chk',1,'6')">&nbsp;Checker (Temp 2): PO
                               </label>
                            ...
                            <td>
                               <label class="checkbox-inline">
                                 ...
                                 onclick="setparameterId('2115','chk',1,'6')">&nbsp;Checker (Temp 3): AVP/SPO
                            ...
                            <td>
                               <label class="checkbox-inline">
                                 ...
                                 onclick="setparameterId('2116','chk',1,'6')">&nbsp;Checker (Temp 4): FVP/SAVP
                         ...
                         <tr>
                           ...
                           <td>
                               <label class="checkbox-inline">
                                 ...
                                 onclick="setparameterId('2117','chk',1,'6')">&nbsp;Checker (Temp 5): SVP/VP
                            ...
                            <td>
                               <label class="checkbox-inline">
                                 ...
                                 onclick="setparameterId('2118','chk',1,'6')">&nbsp;Checker (Temp 6): SEVP/EVP
                           ...
                           <div class="form-group row" style="">
                              <div class="col-lg-offset-2 col-lg-10">
                                 <div class="i-checks">
                                    ...
                                    <input type="text" name="rtgs_tmp_exp_date" id="rtgs_tmp_exp_date" class="rtgs_tmp_exp_date" onclick="setparameterId('1814',document.getElementById('rtgs_tmp_exp_date').value,1,'6');">

                                    <input type="text" name="rtgs_tmp_exp_time" id="rtgs_tmp_exp_time" class="rtgs_tmp_exp_time" onclick="setparameterId('1815',document.getElementById('rtgs_tmp_exp_date').value,1,'6');">
                     ...
                     <div class="col-lg-6 display">
                        <div class="form-group row" style="">
                           <div class="col-lg-6">
                              ...
                              <input type="text" name="158" value="" onchange="setparameterId('158',this.value,1,'6');">
                           </div>
                        </div>
                     </div>
                     ...
                     <table class="table mcr">
                         ...
                         <tr>
                            ...
                            <td>
                                <label class="checkbox-inline">
                                 <input type="checkbox" value="2129" name="2129" onclick="setparameterId('2129','chk',1,'6')">&nbsp; Checker
                               </label>
                            </td>
                            ...
                            <td>
                               <label class="checkbox-inline">
                                 <input type="checkbox" value="151" name="151" onclick="setparameterId('151','chk',1,'6')">&nbsp; Fund Transfer
                               </label>
                            ...
                            <td>
                               <label class="checkbox-inline">
                                 <input type="checkbox" value="152" name="152" onclick="setparameterId('152','chk',1,'6')">&nbsp; Admin
                               </label>
                   ...
                   <tr>
                      <td>
                               <label class="checkbox-inline">
                                 <input type="checkbox" value="153" name="153" onclick="setparameterId('153','chk',1,'6')">&nbsp; Banks Miscellaneous (HO)
                               </label>
                            ...
                            <td>
                               <label class="checkbox-inline">
                                 <input type="checkbox" value="154" name="154" onclick="setparameterId('154','chk',1,'6')">&nbsp; Inter Bank Forex (HO)
                               </label>
                            ...
                            <td>
                               <label class="checkbox-inline">
                                 <input type="checkbox" value="155" name="155" onclick="setparameterId('155','chk',1,'6')">&nbsp; Inter Bank Local (HO)
                               </label>
                            ...
                            <td>
                               <label class="checkbox-inline">
                                 <input type="checkbox" value="156" name="156" onclick="setparameterId('156','chk',1,'6')">&nbsp; UM Maker (For IT)
                               </label>
                              ...
                              <td>
                                 <label class="checkbox-inline">
                                   <input type="checkbox" value="157" name="157" onclick="setparameterId('157','chk',1,'6')">&nbsp; UM Checker (For IT)
                                 </label>
