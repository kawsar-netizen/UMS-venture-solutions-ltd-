                        ...
                        <div class="ibox-content">
                            ...
                            <form action="" method="POST">
                               @csrf
                                ...
                                <div class="form-group row"><label class="col-lg-2 col-form-label"><b>Name </b></label>

                                    <div class="col-lg-10">
                                        <input type="text" id="designation_name" placeholder="Division Name" class="form-control" name="designation_name" required="">
                                    </div>
                            ...
                            <div class="ibox-content">
                                ...
                                <table id="myTable"  class="table table-striped" >
                                    ...
                                    <tr>
                                       ...
                                       @php
                                            $designation_data = DB::table('division')->orderBy('sl', 'desc')->get();
                                            $sl=1;
                                        @endphp
                                        ...
                                        <tr>
                                        	...
                                        	<td>{{ $designation->division }}</td>
                                        	 ...
                                        	 <td style="width:28%">
                                        	 	...
                                        	 	<button onclick="edit_designation(<?php echo $designation->sl; ?>)" class="btn btn-sm btn-info">Edit</button> 
                                        	 </td>
                                        	 <th></th>
