                        ...
                        <table id="myTable" class="table table-striped">
                            <thead>
                                <tr>
                                    ...
                                    <th scope="col" style="color: black">UBS User ID</th>
                            ...
                            <tbody>
                                @if (Auth::user()->role == 5 || Auth::user()->role == 8 || Auth::user()->role == 10 || Auth::user()->role == 2 || Auth::user()->role == 12 || Auth::user()->role == 6)
