...
{   
    ...
    public function user_report_data(Request $request){
       ...
       if ($branch_code && $systems && $division && $status && $user_id &&  $get_frm_date && $get_to_date) {
         ...
         // echo "6 ta dilam";die;
           ...
           if ($status=='7') {
                 ...
                 r_id.branch_code='$branch_code' and  dl.log_division='$division' and u.user_id='$user_id'   and  r_id.entry_date   between '$frm_date 00:00:00' and '$to_date 23:59:59'   order by r_id.sl desc";
      ...
      }elseif ($branch_code && $systems && $division && $user_id && $get_frm_date && $get_to_date) {

           $frm_date = date('Y-m-d', strtotime($get_frm_date));
          $to_date = date('Y-m-d', strtotime($get_to_date));
          
          $condition ="  where  rt.[system_id]='$systems'  and
                 r_id.branch_code='$branch_code' and  dl.log_division='$division'   and  u.user_id='$user_id'   and  r_id.entry_date   between '$frm_date 00:00:00' and '$to_date 23:59:59'    order by r_id.sl desc";

       }elseif ($branch_code && $systems && $division && $get_frm_date && $get_to_date) {

         $frm_date = date('Y-m-d', strtotime($get_frm_date));
          $to_date = date('Y-m-d', strtotime($get_to_date));
          
         $condition ="  where  rt.[system_id]='$systems'  and
                 r_id.branch_code='$branch_code' and  dl.log_division='$division'   and  r_id.entry_date   between '$frm_date 00:00:00' and '$to_date 23:59:59'     order by r_id.sl desc";

       }elseif ($branch_code && $systems && $division && $user_id) {

         $condition ="  where  rt.[system_id]='$systems'  and
                 r_id.branch_code='$branch_code' and  dl.log_division='$division'   and  u.user_id='$user_id'    order by r_id.sl desc";
     ...
     and dl.log_division='$division'  order by r_id.sl desc ";

       

       }elseif($branch_code && $systems && $user_id ){
       ...
       }elseif($branch_code && $status && $user_id && $get_frm_date && $get_to_date){
       ...
       // order by r_id.sl desc";
        ...
        if ($status=='7') {
                 ...
                 r_id.branch_code='$branch_code'  and u.user_id='$user_id'   and  r_id.entry_date  between '$frm_date 00:00:00' and '$to_date 23:59:59'     order by r_id.sl desc";
                  ...
                  $condition ="  where   r_id.status='3' and r_id.action_status_ho_checker='5'  and 
                 r_id.branch_code='$branch_code'  and u.user_id='$user_id'  and  r_id.entry_date  between '$frm_date 00:00:00' and '$to_date 23:59:59'   order by r_id.sl desc";
              ...
              //$branch_code && $status && $user_id && $get_frm_date && $get_to_date


       }elseif ($systems &&  $request_type && $status && $user_id && $get_frm_date && $get_to_date) {
          ...
          if ($status=='7') {
                 ...
                 $condition ="  where rt.[system_id]='$systems'  and   r_id.request_type_id='$request_type'   and  r_id.status='7' and r_id.action_status='7'  and u.user_id='$user_id'  and  r_id.entry_date  between '$frm_date 00:00:00' and '$to_date 23:59:59'    order by r_id.sl desc";
                

              }elseif ($status=='3'){

                  $condition ="  where  rt.[system_id]='$systems'  and   r_id.request_type_id='$request_type'   and   r_id.status='3' and r_id.action_status_ho_checker='5'    and u.user_id='$user_id'   and  r_id.entry_date  between '$frm_date 00:00:00' and '$to_date 23:59:59'    order by r_id.sl desc";
               
              }elseif ($status=='2'){

                  $condition ="  where  rt.[system_id]='$systems'  and   r_id.request_type_id='$request_type'   and    r_id.status='2' and r_id.action_status_ho_checker='5'     and u.user_id='$user_id'  and  r_id.entry_date  between '$frm_date 00:00:00' and '$to_date 23:59:59'   order by r_id.sl desc";
               
              }elseif ($status=='1'){

                  $condition ="  where  rt.[system_id]='$systems'  and   r_id.request_type_id='$request_type'   and  r_id.status<>'7'  and ( r_id.action_status_br_checker='1' or  r_id.action_status_br_checker='2') and (r_id.action_status_ho_checker='' or r_id.action_status_ho_checker IS NULL) 
                  ...
                  $condition ="  where  rt.[system_id]='$systems'   and   r_id.request_type_id='$request_type'    and   r_id.status<>'7' AND ( r_id.action_status_br_checker=''
       ...
       }elseif ($branch_code && $systems &&  $request_type && $division && $get_frm_date && $get_to_date) {

          $frm_date = date('Y-m-d',strtotime($get_frm_date));
          $to_date = date('Y-m-d',strtotime($get_to_date));
        
         $condition ="  where   rt.system_id='$systems'  and  r_id.request_type_id='$request_type' and r_id.branch_code='$branch_code' and dl.log_division='$division'  and r_id.entry_date between  '$frm_date 00:00:00' and '$to_date 23:59:59'   order by r_id.sl desc";
       ...
       }elseif ($systems &&  $request_type && $status && $user_id) {

            if ($status=='7') {


                 $condition ="  where rt.[system_id]='$systems'  and   r_id.request_type_id='$request_type'   and  r_id.status='7' and r_id.action_status='7'  and u.user_id='$user_id'   order by r_id.sl desc";
                

              }elseif ($status=='3'){

                  $condition ="  where  rt.[system_id]='$systems'  and   r_id.request_type_id='$request_type'   and   r_id.status='3' and r_id.action_status_ho_checker='5'    and u.user_id='$user_id'    order by r_id.sl desc";
               
              }elseif ($status=='2'){

                  $condition ="  where  rt.[system_id]='$systems'  and   r_id.request_type_id='$request_type'   and    r_id.status='2' and r_id.action_status_ho_checker='5'     and u.user_id='$user_id'   order by r_id.sl desc";
       ...
       }elseif($systems &&  $request_type && $user_id){

       
                  $condition ="  where  rt.[system_id]='$systems'      and  u.user_id='$user_id'  and   r_id.request_type_id='$request_type'  order by r_id.sl desc";
     ...
     and r_id.entry_date between '$frm_date 00:00:00' and '$to_date 23:59:59'  order by r_id.sl desc";
       ...
       }elseif($branch_code && $status && $get_frm_date && $get_to_date){
     ...
     // and r_id.entry_date between '$frm_date 00:00:00' and '$to_date 23:59:59'  order by r_id.sl desc";
       ...
       }elseif($branch_code  && $get_frm_date && $get_to_date){


         $frm_date = date('Y-m-d', strtotime($get_frm_date));
          $to_date = date('Y-m-d', strtotime($get_to_date));

         $condition ="  where  r_id.branch_code='$branch_code' 
     and r_id.entry_date between '$frm_date 00:00:00' and '$to_date 23:59:59'  order by r_id.sl desc";
      ...
      // order by r_id.sl desc";
                ...
                $auth_division_name=Auth::user()->division_name;
                  ...
                  if ($auth_division_name=='Internal Control Compliance Division'){
                       ...
                       $condition ="  where  rt.[system_id]='$systems'  and  r_id.status='7' and r_id.action_status='7' and 
                       r_id.branch_code='202'  and dl.log_division='$auth_division_name'   and  r_id.entry_date  between '$frm_date 00:00:00' and '$to_date 23:59:59'  order by r_id.sl desc";
      ...
      //       $condition ="  where   s.id='$systems' and r_id.branch_code='202' and dl.log_division='$auth_division_name'
      // order by r_id.sl desc";
         ...
         $frm_date = date('Y-m-d', strtotime($get_frm_date));
          ...
          $condition=" where u.[user_id]='$user_id' and r_id.entry_date  between '$frm_date 00:00:00' and '$to_date 23:59:59'  order by r_id.sl desc ";
       ...
       }elseif ($systems and  $request_type and $status) {
             ...
             if ($status=='7') {
                 ...
                 $condition ="  where  rt.[system_id]='$systems'  and  r_id.status='7' and r_id.action_status='7'  and  rt.system_id='$systems'  and  r_id.request_type_id='$request_type' order by r_id.sl desc";
                

              }elseif ($status=='3'){

                  $condition ="  where  rt.[system_id]='$systems'  and  r_id.status='3' and r_id.action_status_ho_checker='5'  and rt.system_id='$systems'  and  r_id.request_type_id='$request_type'   order by r_id.sl desc";
               
              }elseif ($status=='2'){

                  $condition ="  where  rt.[system_id]='$systems'  and   r_id.status='2' and r_id.action_status_ho_checker='5'  and  rt.system_id='$systems'  and  r_id.request_type_id='$request_type'   order by r_id.sl desc";
               
              }elseif ($status=='1'){

                  $condition ="  where  rt.[system_id]='$systems'  and  r_id.status<>'7'  and ( r_id.action_status_br_checker='1' or  r_id.action_status_br_checker='2') and (r_id.action_status_ho_checker='' or r_id.action_status_ho_checker IS NULL) and rt.system_id='$systems'  and  r_id.request_type_id='$request_type'    order by r_id.sl desc";
                  ...
                  $condition ="  where  rt.[system_id]='$systems'  and r_id.status<>'7' AND ( r_id.action_status_br_checker=''
              OR  r_id.action_status_br_checker IS NULL ) and  rt.system_id='$systems'  and  r_id.request_type_id='$request_type'   order by r_id.sl desc";
               
              }
        
          // $condition ="  where   rt.system_id='$systems'  and  r_id.request_type_id='$request_type' and r_id.entry_date  between '$frm_date 00:00:00' and '$to_date 23:59:59'  order by r_id.sl desc";
      

       }elseif ($systems and  $request_type and $get_frm_date and $get_to_date) {
        ...
        // echo "545";die;
         ...
         if(Auth::user()->role=='1'  || Auth::user()->role=='5'){
          ...
          $condition=" where rt.[system_id]='$systems' and r_id.branch_code='$auth_my_branch' and dl.log_division='$division_name' and r_id.entry_date  between '$frm_date 00:00:00' and '$to_date 23:59:59'  order by r_id.sl desc ";
           ...
           if ($status=='7') {
            ...
            // echo $division;die;
               if ($status=='7') {
                     ...
                     $condition ="  where  rt.[system_id]='$systems'  and  r_id.status='7' and r_id.action_status='7' and 
                     r_id.branch_code='$branch_code'  and dl.log_division='$division'   order by r_id.sl desc";
   ...
   and  r_id.entry_date  between '$frm_date 00:00:00' and '$to_date 23:59:59'  order by r_id.sl desc ";
     ...
     and dl.log_division='$division'  order by r_id.sl desc ";
       ...
       }elseif ($branch_code && $systems &&  $request_type && $division) {

         $condition ="  where   rt.system_id='$systems'  and  r_id.request_type_id='$request_type' and r_id.branch_code='$branch_code' and dl.log_division='$division'  order by r_id.sl desc";
        ...
        //  $condition ="  where   rt.system_id='$systems'  and  r_id.request_type_id='$request_type' and r_id.branch_code='$branch_code' order by r_id.sl desc";
         ...
         and dl.log_division='$division'  order by r_id.sl desc ";
               ...
               if ($status=='7') {
                    ...
                    $condition ="  where (r_id.status='7' and r_id.action_status='7')    and r_id.branch_code='$branch_code' and dl.log_division='$division'  order by r_id.sl desc";
                    ...
                    $condition ="   where (r_id.status='3' and r_id.action_status_ho_checker='5')    and r_id.branch_code='$branch_code' and dl.log_division='$division'  order by r_id.sl desc";
                    ...
                    $condition ="  where  (r_id.status='2' and r_id.action_status_ho_checker='5')    and r_id.branch_code='$branch_code' and dl.log_division='$division'  order by r_id.sl desc";

             }elseif ($status=='1') {
                  
                 
                     $condition ="  where (r_id.status='0' and r_id.action_status_br_checker='1')  and r_id.branch_code='$branch_code' and dl.log_division='$division'  order by r_id.sl desc";

             }elseif($status=='10'){


                  $condition ="   where (r_id.status<>'7' and  r_id.action_status_br_checker=''
              OR  r_id.action_status_br_checker IS NULL )   and r_id.branch_code='$branch_code' and  dl.log_division='$division'  order by r_id.sl desc";
     ...
     and dl.log_division='$division'  order by r_id.sl desc";
          ...
          $condition ="  where  r_id.branch_code='$branch_code'   and dl.log_division='$division'  order by r_id.sl desc";
      ...
      // order by r_id.sl desc";
               ...
               if ($auth_division_name=='Internal Control Compliance Division'){
                    ...
                    OR  r_id.action_status_br_checker IS NULL )     order by r_id.sl desc";
                     ...
                     $condition ="  where  rt.[system_id]='$systems'  and  r_id.status='7' and r_id.action_status='7' and 
                     r_id.branch_code='202'  and dl.log_division='$auth_division_name'  order by r_id.sl desc";
       ...
       order by r_id.sl desc";
         ...
         if(Auth::user()->role=='1'  || Auth::user()->role=='5'){
              ...
              $auth_division_name =  Auth::user()->division_name;
               ...
               if ($auth_division_name=='Internal Control Compliance Division'){
                  ...
                  $condition ="  where  r_id.branch_code='$branch_code'   order by r_id.sl desc ";
                   ...
                   $condition ="  where  r_id.branch_code='202'  and dl.log_division='$auth_division_name' ";
               }
            ...
            if (Auth::user()->role=='1' || Auth::user()->role=='5') {
                ...
                $auth_division_name =  Auth::user()->division_name;
                 ...
                 and dl.log_division='$auth_division_name'  order by r_id.sl desc ";
        ...
        //echo"34334";die;
         ...
         if ($status=='7') {
              ...
              if(Auth::user()->role=='1' || Auth::user()->role=='5'){
                 ...
                 if ($auth_division_name=='Internal Control Compliance Division'){
                    ...
                    $condition ="  where  r_id.status='3' and r_id.action_status_ho_checker='5'  and r_id.branch_code='202' and dl.log_division='$auth_division_name' and r_id.entry_date between '$frm_date 00:00:00' and '$to_date 23:59:59'  order by r_id.sl desc";
               ...
               if(Auth::user()->role=='1'  || Auth::user()->role=='5'){
                 ...
                 $auth_division_name =  Auth::user()->division_name;
                  ...
                  if ($auth_division_name=='Internal Control Compliance Division'){
                     ...
                     $condition ="  where  r_id.status='2' and r_id.action_status_ho_checker='5'  and  r_id.branch_code='202' and dl.log_division='$auth_division_name'  and r_id.entry_date between '$frm_date 00:00:00' and '$to_date 23:59:59'  order by r_id.sl desc";
               ...
               if(Auth::user()->role=='1' || Auth::user()->role=='5'){
                 ...
                 $auth_division_name =  Auth::user()->division_name;
                  ...
                  if ($auth_division_name=='Internal Control Compliance Division'){
                       ...
                       $condition ="  where r_id.status<>'7'  and ( r_id.action_status_br_checker='1' or  r_id.action_status_br_checker='2') and (r_id.action_status_ho_checker='' or r_id.action_status_ho_checker IS NULL)    and r_id.entry_date between '$frm_date 00:00:00' and '$to_date 23:59:59'  order by r_id.sl desc";  
            ...
            if(Auth::user()->role=='1' || Auth::user()->role=='5'){
              ...
              OR  r_id.action_status_br_checker IS NULL )  and r_id.entry_date between '$frm_date 00:00:00' and '$to_date 23:59:59'  order by r_id.sl desc";  
                      ...
                      $condition ="  where r_id.status<>'7' and ( r_id.action_status_br_checker=''
              OR  r_id.action_status_br_checker IS NULL )  and r_id.branch_code='202' and dl.log_division='$auth_division_name' and r_id.entry_date between '$frm_date 00:00:00' and '$to_date 23:59:59' order by r_id.sl desc";
         ...
         // end filter just status && date
          ...
          $condition ="  where  dl.log_division='$division'  order by r_id.sl desc";
         ...
         if ($status=='7') {
              ...
              if(Auth::user()->role=='1' || Auth::user()->role=='5'){
                 ...
                 if ($auth_division_name=='Internal Control Compliance Division'){
                    ...
                    $condition ="  where  r_id.status='3' and r_id.action_status_ho_checker='5'  and r_id.branch_code='202' and dl.log_division='$auth_division_name'  order by r_id.sl desc";
               ...
               if(Auth::user()->role=='1'  || Auth::user()->role=='5'){
                 ...
                 $auth_division_name =  Auth::user()->division_name;
                   ...
                   if ($auth_division_name=='Internal Control Compliance Division'){
                       ...
                       $condition ="  where  r_id.status='2' and r_id.action_status_ho_checker='5'  and  r_id.branch_code='202' and dl.log_division='$auth_division_name'   order by r_id.sl desc";
               ...
               if(Auth::user()->role=='1' || Auth::user()->role=='5'){
                 ...
                 $auth_division_name =  Auth::user()->division_name;
                  ...
                  if ($auth_division_name=='Internal Control Compliance Division'){
                      ...
                      $condition ="   where r_id.status<>'7'  and ( r_id.action_status_br_checker='1' or  r_id.action_status_br_checker='2') and (r_id.action_status_ho_checker='' or r_id.action_status_ho_checker IS NULL)  order by r_id.sl desc";  
              ...
              OR  r_id.action_status_br_checker IS NULL )  and r_id.branch_code='$auth_my_branch'   order by r_id.sl desc";
                 ...
                 $auth_my_branch =  Auth::user()->branch;
                  ...
                  OR  r_id.action_status_br_checker IS NULL )  order by r_id.sl desc";  
                       ...
                       $condition ="  where r_id.status<>'7' and ( r_id.action_status_br_checker=''
              OR  r_id.action_status_br_checker IS NULL )  and r_id.branch_code='202' and dl.log_division='$auth_division_name' order by r_id.sl desc";
            ...
            //for division maker, checker
             ...
             $auth_my_branch =  Auth::user()->branch;
              ...
              if ($auth_division_name=='Internal Control Compliance Division') {
                ...
                $condition ="   where r_id.entry_date  between '$frm_date 00:00:00' and '$to_date 23:59:59' and r_id.branch_code='$auth_my_branch'  and dl.log_division='$auth_division_name'   order by r_id.sl desc";
              }
         ...
         $frm_date = date('Y-m-d', strtotime($get_frm_date));
          ...
          if (Auth::user()->role=='1' || Auth::user()->role=='5') {
            ...
            if ($auth_division_name=='Internal Control Compliance Division') {
                ...
                $condition ="   where r_id.branch_code='202'  and dl.log_division='$auth_division_name' and r_id.entry_date  between '$frm_date 00:00:00' and '$to_date 23:59:59'   order by r_id.sl desc";
              }
             ...
             $condition ="  where  r_id.branch_code='$auth_branch'   order by r_id.sl desc";
              ...
              if ($auth_division_name=='Internal Control Compliance Division') {
                ...
                $condition=" order by r_id.sl desc";
                 ...
                 $condition ="  where  r_id.branch_code='202'  and dl.log_division='$auth_division_name'  order by r_id.sl desc";
 ...
 //    $condition   ";die;
    ...
    //       file_put_contents('t.txt', "SELECT
    //    r_id.[sl],
    //    [req_id],
    //    r_id.[status],
    //    r_id.[action_status],
