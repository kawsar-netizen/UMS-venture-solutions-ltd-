...
{  
  ...
  if (in_array('2', $system_exist_this_audit_id)) {
     ...
     $checked_system_docudex="";
  if (in_array('1004', $system_exist_this_audit_id)) {

     $checked_system_docudex="checked";
  }else{
     $checked_system_docudex= "";
  }
     $checked_system_csms="";
  if (in_array('1005', $system_exist_this_audit_id)) {

     $checked_system_csms="checked";
  }else{
     $checked_system_csms= "";
  }
     $checked_system_nsmart="";
  if (in_array('1013', $system_exist_this_audit_id)) {

     $checked_system_nsmart="checked";
  }else{
     $checked_system_nsmart= "";
  }
     $checked_system_land="";
  if (in_array('1018', $system_exist_this_audit_id)) {

     $checked_system_land="checked";
  }else{
     $checked_system_land= "";
  }
     $checked_system_call_center="";
  if (in_array('1014', $system_exist_this_audit_id)) {

     $checked_system_call_center="checked";
  }else{
     $checked_system_call_center= "";
  }
     $checked_system_tp_kyc="";
  if (in_array('1011', $system_exist_this_audit_id)) {

     $checked_system_tp_kyc="checked";
  }else{
     $checked_system_tp_kyc= "";
  }
     $checked_system_cpc="";
  if (in_array('1026', $system_exist_this_audit_id)) {

     $checked_system_cpc="checked";
  }else{
     $checked_system_cpc= "";
  }
     $checked_system_solution="";
  if (in_array('1025', $system_exist_this_audit_id)) {

     $checked_system_solution="checked";
  }else{
     $checked_system_solution= "";
  }
     $checked_system_automated="";
  if (in_array('1020', $system_exist_this_audit_id)) {

     $checked_system_automated="checked";
  }else{
     $checked_system_automated= "";
  }
...
We have received user access audit sheet from your Branch/Division for following systems:
     ...
     &nbsp;
      ...
      <input type="checkbox" value="1004" name="docudex" '.$checked_system_docudex.' id="docudex" style="margin-top:5px;"> Docudex &nbsp;
      <input type="checkbox" value="1005" name="csms" '.$checked_system_csms.' id="csms" style="margin-top:5px;"> CSMS &nbsp;
      <input type="checkbox" value="1013" name="nsmart" '.$checked_system_nsmart.' id="nsmart" style="margin-top:5px;">  nScreen And nSmart &nbsp;
      <input type="checkbox" value="1018" name="land" '.$checked_system_land.' id="land" style="margin-top:5px;"> E-lending &nbsp;
      <input type="checkbox" value="1014" name="call_center" '.$checked_system_call_center.' id="call_center" style="margin-top:5px;"> Call Center System &nbsp;
      <input type="checkbox" value="1011" name="tp_kyc" '.$checked_system_tp_kyc.' id="tp_kyc" style="margin-top:5px;"> TP & KYC System &nbsp;
      <input type="checkbox" value="1026" name="cpc" '.$checked_system_cpc.' id="cpc" style="margin-top:5px;"> CPC Plus &nbsp;
      <input type="checkbox"  value="1025" name="solution" '.$checked_system_solution.' id="solution" style="margin-top:5px;"> C Solution &nbsp;
      <input type="checkbox" value="1020" name="automated" '.$checked_system_automated.' id="automated" style="margin-top:5px;"> Automated Challan System &nbsp;
  ...
  <p><b>Remarks:</b> Please note that we did not receive User Access Audit Sheet of '.$remarks_system.'. You are requested to send the
    ...
    <p><b> N:B: </b>
    This is a auto generated documnet. No signature is required.
    </p>
      <div class="parent">
