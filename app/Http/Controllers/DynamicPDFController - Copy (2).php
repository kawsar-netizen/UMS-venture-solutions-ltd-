...
Tel: 58314424, Fax: 880-2-58314419, Website: www.dhakabankltd.com ,E-mail : info@dhakabank.com.bd
    ...
    <p>&nbsp;</p>
     ...
     <div id="wrapper" style="margin-top:50px; width: 100%;"> 
        ...
        <table style="width:100px;">
          ...
          <tr>
            <td style="width:50%">MaHello   ker</td>
            <td>Rabiul Hasan</td>
          </tr>
        </table>
       ...
       <span>Remarks: Please note that we did not receive User Access Audit Sheet of '.$remarks_system.'. You are requested to send the
