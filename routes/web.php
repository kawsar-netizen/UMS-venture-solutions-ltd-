...
//coding by kawsar khan
Route::get('/request_type/{id}','parameterSetupController@request_delete')->name('request_type_delete');
...
// UBS user unlock request report route

Route::get('ubs_unlock_request_report', 'ReportController@ubs_unlock_request_report')->name('ubs_unlock_request_report');
Route::get('ubs_unlock_report_data','ReportController@ubs_unlock_report_data')->name('ubs_unlock_report_data');
